...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$train$validation <- c(202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007)
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( paste0(pnombrewf, "_ZZ0002"), c(paste0(pnombrewf, "_HT0002"), paste0(pnombrewf, "_TS0002")) )
