...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$CanaritosAsesinos$ratio <- 0
  # desvios estandar de la media, para el cutoff
  param_local$CanaritosAsesinos$desvios <- 1.75
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_MODELOFINAL", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_MODELOFINAL", "DT0001_MODELOFINAL" )

  DR_drifting_guantesblancos( "DR0001_MODELOFINAL", "CA0001_MODELOFINAL" )
  FE_historia_guantesblancos( "FE0001_MODELOFINAL", "DR0001_MODELOFINAL" )

  TS_strategy_guantesblancos_202109( "TS0001_MODELOFINAL", "FE0001_MODELOFINAL" )

  HT_tuning_guantesblancos( "HT0001_MODELOFINAL", "TS0001_MODELOFINAL" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline("ZZ0001_MODELOFINAL", c("HT0001_MODELOFINAL","TS0001_MODELOFINAL"))
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_MODELOFINAL", "FE0001_MODELOFINAL" )

  HT_tuning_guantesblancos( "HT0002_MODELOFINAL", "TS0002_MODELOFINAL" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_MODELOFINAL", c("HT0002_MODELOFINAL", "TS0002_MODELOFINAL") )
...
corrida_guantesblancos_202109( "gb01_MODELOFINAL" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

#corrida_guantesblancos_202107( "gb02_MODELOFINAL" )
